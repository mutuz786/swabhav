<%@page import="com.techlab.filter.SessionCheck"%>
<%@page import="com.techlab.model.Session"%>
...
<body>
	...
	<table>
		<tr>
			...
			<td>age</td>
			<%
				if (Session.getInstance().getStatus(request.getSession().getId())) {
		...
		<%
			...
			for (Student entry : entries) {
				...
				if (Session.getInstance().getStatus(request.getSession().getId())) {
					out.println("<td> <a href='EditStudent?id=" + entry.getId() + "'>edit</a></td>");
