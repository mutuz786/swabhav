...
public class FindGuitarTest {
	public static void main(String[] args) {
		...
		inventory.addInventory("101", 54329.63, "gt-82", 12, Builder.MARTIN, Type.ELECTRIC, Wood.BRAZILIAN_ROSEWOOD,
				Wood.MAPLE);
		inventory.addInventory("102", 82724.54, "straga", 7, Builder.COLLINGS, Type.ACCOUSTIC, Wood.COCOBOLO,
				Wood.INDIAN_ROSEWOOD);
		inventory.addInventory("103", 65223.32, "yts-82", 7, Builder.COLLINGS, Type.ACCOUSTIC, Wood.COCOBOLO,
				Wood.INDIAN_ROSEWOOD);
		...
		GuitarSpec requirement = new GuitarSpec("", 7, Builder.COLLINGS, Type.ACCOUSTIC, Wood.COCOBOLO,
				Wood.INDIAN_ROSEWOOD);
